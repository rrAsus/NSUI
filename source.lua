...
function HDXLib:CreateWindow(Settings)
	...
	pcall(function()
		...
		if not isfolder(HDXLib.."/".."Configuration Folders") then
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function(EnterPressed)
				...
				if KeyFound then
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(HDXFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, Settings.KeySettings.Key)
						end
